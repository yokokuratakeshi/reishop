...
const adminFranchises: ManualArticle = {
  ...
  title: "加盟店管理",
  description: "加盟店の追加、招待リンク発行、アカウント設定",
  icon: "Store",
  role: "admin",
  sections: [
    {
      ...
      steps: [
        ...
        {
          title: "ログインアカウントを設定する（任意）",
          description: "ダイアログ下部の「ログインアカウント設定」でメールアドレスとパスワードを入力すると、その場でアカウントが作成されます。空欄のままにすると、後から招待リンクで作成してもらうことができます。",
        },
        {
          title: "「保存」をクリック",
    ...
    {
      heading: "招待リンクでアカウントを作成してもらう",
      steps: [
        {
          title: "招待リンクボタンをクリック",
          description: "アカウント未作成の加盟店カードに表示されるリンクアイコン（🔗）をクリックします。",
        },
        {
          title: "招待リンクをコピーする",
          description: "ダイアログに表示された招待URLのコピーボタンをクリックします。このリンクは7日間有効です。",
        },
        {
          title: "加盟店にリンクを共有する",
          description: "コピーしたリンクをメールやLINEで加盟店の担当者に送ります。",
          tips: "加盟店がリンクを開くと、メールアドレスとパスワードの設定画面が表示されます。設定完了後、自動的にログインされカタログページが表示されます。",
        },
      ],
    },
    {
  ...
  sections: [
    {
      ...
      steps: [
        {
          title: "招待リンクを開く",
          description: "フランチャイズオーナーから共有された招待リンクをブラウザで開きます。「アカウント作成」画面が表示されます。",
        },
        {
          title: "メールアドレスを入力する",
          description: "ログインに使用するメールアドレスを入力します。普段お使いのメールアドレスをお勧めします。",
        },
        {
          title: "パスワードを設定する",
          description: "6文字以上のパスワードを入力し、確認欄にもう一度同じパスワードを入力します。",
          tips: "パスワードは忘れないようにメモしておきましょう。",
        },
        {
          title: "「アカウントを作成」をクリック",
          description: "ボタンをクリックすると、アカウントが作成され自動的にカタログページにログインされます。",
        },
      ],
    },
  ],
